...
export const contractDataSchema = z.object({
  ...
  'DIA VENCIMENTO MENSAL': z.union([z.number(), z.string()]).optional().transform(val => val ? Number(val) : undefined),
  ...
  'TIPO_NEGOCIACAO': z.string().optional().or(z.literal('')),
  'QTD_PRIMEIRAS_PARCELAS': z.union([z.number(), z.string()]).optional().transform(val => val ? Number(val) : undefined),
