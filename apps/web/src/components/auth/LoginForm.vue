  ...
  <div class="w-full h-full flex flex-col">
    ...
    <div class="mb-auto">
      ...
      <div class="flex items-center gap-2.5 mb-3">
        ...
        <span
          class="text-brand-cyan text-[10px] font-semibold uppercase tracking-[0.18em]"
      ...
      <!-- Título principal -->
      <h1
        class="text-[2.1rem] font-extrabold leading-[1.1] tracking-[-0.03em] text-white"
      >
    ...
    <div class="flex-1 flex items-center justify-center">
      <div class="w-full max-w-[420px]">
        ...
        <!-- Form -->
        <form
          class="space-y-5 w-full flex flex-col justify-center"
        ...
        >
          ...
          <div>
            <label
              for="email"
              class="block text-xs font-semibold uppercase tracking-widest mb-2 text-brand-cyan"
            >
              E-mail
            </label>
            <input
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              <label
                for="password"
                class="block text-xs font-semibold uppercase tracking-widest text-brand-cyan"
              >
                Senha
              </label>
            </div>
