              ...
              >
                <td class="px-8 py-5">
                  <div class="flex items-center gap-4">
                    <div
                      class="h-10 w-10 rounded-2xl bg-brand-cyan/10 flex items-center justify-center border border-brand-cyan/20 shadow-lg shadow-brand-cyan/5 group-hover:scale-110 transition-transform duration-500"
                    >
                      <component
                        :is="
                          goal.target_type === 'bu'
                    ...
                    <div>
                      ...
                      <div class="text-[9px] text-white/20 font-bold uppercase tracking-widest mt-0.5">
                        ID: {{ goal.target_id }}
                      </div>
                    </div>
                  </div>
