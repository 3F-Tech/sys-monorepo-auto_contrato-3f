    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <span v-if="errors && errors['RAZAO SOCIAL DO CONTRATANTE']" role="alert"
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <span v-if="errors && errors['NOME DO REPRESENTANTE']" role="alert"
            class="text-[9px] text-red-500 font-bold mt-1 block">
        ...
        <div class="space-y-2">
          ...
          <span v-if="errors && errors['EMAIL DO REPRESENTANTE']" role="alert"
            class="text-[9px] text-red-500 font-bold mt-1 block">
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <span v-if="errors && errors['PRAZO CONTRATUAL MESES']" role="alert"
            class="text-[9px] text-red-500 font-bold mt-1 block text-left">
