    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-2">
          ...
          <input type="email" id="EMAIL DO REPRESENTANTE" v-model="form['EMAIL DO REPRESENTANTE']" class="input-glass w-full"
            placeholder="email@empresa.com" :class="[errors && errors['EMAIL DO REPRESENTANTE'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input type="text" id="TELEFONE FINANCEIRO CONTRATANTE" v-model="form['TELEFONE FINANCEIRO CONTRATANTE']" v-maska="'(##) #####-####'"
        ...
        <div class="space-y-2">
          ...
          <input type="email" id="EMAIL FINANCEIRO CONTRATANTE" v-model="form['EMAIL FINANCEIRO CONTRATANTE']" class="input-glass w-full"
        ...
        <div class="space-y-2 md:col-span-2">
          ...
          <div class="relative">
            ...
            <input type="text" id="LINK INSTAGRAM CONTRATANTE" v-model="form['LINK INSTAGRAM CONTRATANTE']" 
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div v-if="showArtes" class="space-y-2">
          ...
          <input type="text" id="QTD ARTES" v-model="form['QTD ARTES']" class="input-glass w-full" placeholder="Ex: 10 ou Ilimitado" :class="[errors && errors['QTD ARTES'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5' : '']">
        ...
        <div v-if="showVideos" class="space-y-2">
          ...
          <input type="text" id="QTD VIDEOS" v-model="form['QTD VIDEOS']" class="input-glass w-full" placeholder="Ex: 4 ou Ilimitado" :class="[errors && errors['QTD VIDEOS'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5' : '']">
      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
          <div class="space-y-2">
            ...
            <input type="text" v-model="form['NOME VENDEDOR']" class="input-glass w-full text-brand-cyan/90 font-medium" placeholder="NOME DO VENDEDOR" :class="[errors && errors['NOME VENDEDOR'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          ...
          <div class="space-y-2">
            ...
            <input type="text" v-model="form['CPF VENDEDOR']" v-maska="'###.###.###-##'" class="input-glass w-full" placeholder="000.000.000-00" :class="[errors && errors['CPF VENDEDOR'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          ...
          <div class="space-y-2">
            ...
            <input type="text" v-model="form['NOME COORD BU']" class="input-glass w-full" placeholder="NOME DO COORDENADOR" :class="[errors && errors['NOME COORD BU'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          ...
          <div class="space-y-2">
            ...
            <input type="text" v-model="form['CPF COORD BU']" v-maska="'###.###.###-##'" class="input-glass w-full" placeholder="000.000.000-00" :class="[errors && errors['CPF COORD BU'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          ...
          <div class="space-y-2">
            ...
            <input type="text" id="CPF SDR" v-model="form['CPF SDR']" v-maska="'###.###.###-##'" class="input-glass w-full" placeholder="000.000.000-00" :class="[errors && errors['CPF SDR'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
