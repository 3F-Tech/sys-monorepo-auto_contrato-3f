<template>
  <div class="space-y-12 pb-20">
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="md:col-span-1 space-y-2">
          ...
          <input
            type="text"
            id="ID DO DOCUMENTO CLICKSIGN"
            v-model="form['ID DO DOCUMENTO CLICKSIGN']"
            class="input-glass w-full border-brand-cyan/20 focus:border-brand-cyan"
            placeholder="Ex: e619b024-..."
            :class="[
          ...
          />
          <span
            v-if="errors && errors['ID DO DOCUMENTO CLICKSIGN']"
            role="alert"
        ...
        <div
          v-if="form['ID DO DOCUMENTO CLICKSIGN']"
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input
            type="text"
            id="RAZAO SOCIAL DO CONTRATANTE"
            v-model="form['RAZAO SOCIAL DO CONTRATANTE']"
          ...
          />
          <span
            v-if="errors && errors['RAZAO SOCIAL DO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
        ...
        <div class="space-y-2">
          ...
          <input
            type="text"
            id="CNPJ DO CONTRATANTE"
            v-model="form['CNPJ DO CONTRATANTE']"
            v-maska="{ mask: ['###.###.###-##', '##.###.###/####-##'] }"
            class="input-glass w-full"
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div class="md:col-span-3 space-y-2">
          ...
          <input
            type="text"
            id="CEP DO CONTRATANTE"
            v-model="form['CEP DO CONTRATANTE']"
            v-maska="'#####-###'"
            class="input-glass w-full"
        ...
        <div class="md:col-span-6 space-y-2">
          ...
          <input
            type="text"
            id="LOGRADOURO DO CONTRATANTE"
            v-model="form['LOGRADOURO DO CONTRATANTE']"
            class="input-glass w-full"
          ...
          />
          <span
            v-if="errors && errors['LOGRADOURO DO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
        ...
        <div class="md:col-span-3 space-y-2">
          ...
          <input
            type="text"
            id="NUMERO DO CONTRATANTE"
            v-model="form['NUMERO DO CONTRATANTE']"
            class="input-glass w-full"
            placeholder="123"
            :class="[
        ...
        <div class="md:col-span-5 space-y-2">
          ...
          <input
            type="text"
            id="BAIRRO DO CONTRATANTE"
            v-model="form['BAIRRO DO CONTRATANTE']"
            class="input-glass w-full"
        ...
        <div class="md:col-span-5 space-y-2">
          ...
          <input
            type="text"
            id="CIDADE DO CONTRATANTE"
            v-model="form['CIDADE DO CONTRATANTE']"
            class="input-glass w-full"
            placeholder="CIDADE"
            :class="[
        ...
        <div class="md:col-span-2 space-y-2">
          ...
          <input
            type="text"
            id="UF DO CONTRATANTE"
            v-model="form['UF DO CONTRATANTE']"
            v-maska="'@@'"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input
            ...
            v-model="form['NOME DO REPRESENTANTE']"
            class="input-glass w-full"
        ...
        <div class="space-y-2">
          ...
          <input
            type="email"
            id="EMAIL DO REPRESENTANTE"
            v-model="form['EMAIL DO REPRESENTANTE']"
            class="input-glass w-full"
        ...
        <div class="space-y-2">
          ...
          <input
            type="text"
            id="CPF DO REPRESENTANTE"
            v-model="form['CPF DO REPRESENTANTE']"
            v-maska="'###.###.###-##'"
            class="input-glass w-full"
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input
            type="text"
            id="TELEFONE FINANCEIRO CONTRATANTE"
            v-model="form['TELEFONE FINANCEIRO CONTRATANTE']"
            v-maska="'(##) #####-####'"
            class="input-glass w-full"
          ...
          />
          <span
            v-if="errors && errors['TELEFONE FINANCEIRO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
        ...
        <div class="space-y-2">
          ...
          <input
            type="email"
            id="EMAIL FINANCEIRO CONTRATANTE"
            v-model="form['EMAIL FINANCEIRO CONTRATANTE']"
            class="input-glass w-full"
          ...
          />
          <span
            v-if="errors && errors['EMAIL FINANCEIRO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
        ...
        <div class="space-y-2 md:col-span-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">
            LINK INSTAGRAM DO CONTRATANTE
          </label>
          <div class="relative">
            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 text-xs font-bold">@</span>
            <input
              type="text"
              id="LINK INSTAGRAM CONTRATANTE"
              v-model="form['LINK INSTAGRAM CONTRATANTE']"
              @input="form['LINK INSTAGRAM CONTRATANTE'] = ($event.target as HTMLInputElement).value.replace(/@/g, '')"
              class="input-glass w-full !pl-8"
              placeholder="Ex: joao_pizzaria (sem o @)"
              :class="[
                errors && errors['LINK INSTAGRAM CONTRATANTE']
                  ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5'
                  : '',
              ]"
            />
          ...
          <span
            v-if="errors && errors['LINK INSTAGRAM CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
            {{ errors['LINK INSTAGRAM CONTRATANTE'] }}
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input
            type="number"
            id="PRAZO CONTRATUAL MESES"
            v-model="form['PRAZO CONTRATUAL MESES']"
            class="input-glass w-full"
            placeholder="12"
            :class="[
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            v-model="form['DATA ASSINATURA CONTRATO']"
            v-maska="'##/##/####'"
            class="input-glass w-full"
          ...
          />
          <span
            v-if="errors && errors['DATA ASSINATURA CONTRATO']"
            class="text-[9px] text-red-500 font-bold mt-1 block"
          >
        ...
        <div v-if="showArtes" class="space-y-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">QTD ARTES</label>
          <input
            type="text"
            id="QTD ARTES"
            v-model="form['QTD ARTES']"
            class="input-glass w-full"
            placeholder="Ex: 10 ou Ilimitado"
            :class="[
              errors && errors['QTD ARTES'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5' : '',
            ]"
          />
          <span v-if="errors && errors['QTD ARTES']" class="text-[9px] text-red-500 font-bold mt-1 block">
            {{ errors['QTD ARTES'] }}
          </span>
        </div>
        <div v-if="showVideos" class="space-y-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">QTD VÍDEOS</label>
          <input
            type="text"
            id="QTD VIDEOS"
            v-model="form['QTD VIDEOS']"
            class="input-glass w-full"
            placeholder="Ex: 4 ou Ilimitado"
            :class="[
              errors && errors['QTD VIDEOS']
                ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5'
                : '',
            ]"
          />
          <span v-if="errors && errors['QTD VIDEOS']" class="text-[9px] text-red-500 font-bold mt-1 block">
            {{ errors['QTD VIDEOS'] }}
          </span>
        </div>
      </div>
    ...
    <NegotiationSection :form="form" :errors="errors" :clause-number="5" :fixed-boilerplate="bommaBoilerplate" />
...
import { ref, watch, computed } from 'vue'
  ...
  const bommaBoilerplate = [
    ...
    'Em caso de não pagamento voluntário pela CONTRATANTE da remuneração no prazo estipulado, a CONTRATADA poderá propor medida judicial para cobrança do valor da remuneração inadimplida, independentemente de notificação, corrigida monetariamente pelo índice do IPCA a partir da data do vencimento até a data do efetivo pagamento, acrescida de juros moratórios de 1% (um por cento) ao mês, multa de 2% (dois por cento) e honorários advocatícios de 10% (dez por cento), calculados sobre o valor pendente de adimplemento, sem prejuízo de pleitear eventuais perdas e danos.',
  ]

  const { loading: cepLoading, fetchAddress } = useCep()

  const showArtes = computed(() => {
    const tName = props.templateName.toUpperCase()
    return tName.includes('ARTES') || tName.includes('DETERMINADA')
  })

  const showVideos = computed(() => {
    const tName = props.templateName.toUpperCase()
    return tName.includes('VÍDEOS') || tName.includes('VIDEOS') || tName.includes('DETERMINADA')
  })
  ...
  watch(
    () => props.form['LINK INSTAGRAM CONTRATANTE'],
    (newVal) => {
