  ...
  <div class="space-y-12 pb-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-2">
          ...
          <input type="text" id="TELEFONE FINANCEIRO CONTRATANTE" v-model="form['TELEFONE FINANCEIRO CONTRATANTE']"
            v-maska="'(##) #####-####'" class="input-glass w-full" placeholder="(00) 00000-0000"
            :class="[errors && errors['TELEFONE FINANCEIRO CONTRATANTE'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          <span v-if="errors && errors['TELEFONE FINANCEIRO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block">{{ errors['TELEFONE FINANCEIRO CONTRATANTE'] }}</span>
        </div>
        <div class="space-y-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">E-MAIL FINANCEIRO</label>
          <input type="email" id="EMAIL FINANCEIRO CONTRATANTE" v-model="form['EMAIL FINANCEIRO CONTRATANTE']"
            class="input-glass w-full" placeholder="financeiro@empresa.com"
            :class="[errors && errors['EMAIL FINANCEIRO CONTRATANTE'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          <span v-if="errors && errors['EMAIL FINANCEIRO CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block">{{ errors['EMAIL FINANCEIRO CONTRATANTE'] }}</span>
        </div>
        <div class="space-y-2 md:col-span-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">LINK INSTAGRAM DO
            CONTRATANTE</label>
          <div class="relative">
            ...
            <input type="text" id="LINK INSTAGRAM CONTRATANTE" v-model="form['LINK INSTAGRAM CONTRATANTE']"
              ...
              class="input-glass w-full !pl-8" placeholder="Ex: joao_pizzaria (sem o @)"
              :class="[errors && errors['LINK INSTAGRAM CONTRATANTE'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-500/5' : '']">
          </div>
          <span v-if="errors && errors['LINK INSTAGRAM CONTRATANTE']"
            class="text-[9px] text-red-500 font-bold mt-1 block">{{ errors['LINK INSTAGRAM CONTRATANTE'] }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-2">
          <label class="text-[10px] font-bold text-white/40 uppercase tracking-widest">VALOR DO PRIMEIRO PAGAMENTO
            (P1)</label>
          <div class="relative">
            <span
              class="absolute left-4 h-full flex items-center text-brand-cyan/40 text-xs font-bold pointer-events-none">R$</span>
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div v-if="showArtes" class="space-y-2">
          ...
          <input type="text" id="QTD ARTES" v-model="form['QTD ARTES']" class="input-glass w-full"
            placeholder="Ex: 10 ou Ilimitado"
            :class="[errors && errors['QTD ARTES'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5' : '']">
          <span v-if="errors && errors['QTD ARTES']" class="text-[9px] text-red-500 font-bold mt-1 block">{{
            errors['QTD ARTES'] }}</span>
        </div>
        <div v-if="showVideos" class="space-y-2">
          ...
          <input type="text" id="QTD VIDEOS" v-model="form['QTD VIDEOS']" class="input-glass w-full"
            placeholder="Ex: 4 ou Ilimitado"
            :class="[errors && errors['QTD VIDEOS'] ? '!border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-red-50/5' : '']">
          <span v-if="errors && errors['QTD VIDEOS']" class="text-[9px] text-red-500 font-bold mt-1 block">{{
            errors['QTD VIDEOS'] }}</span>
        </div>
      </div>
    </div>
