...
5. **Automação de Formulários:** Ao iniciar a criação de um contrato, os campos "Vendedor" e "Coordenador de BU" devem ser pré-preenchidos automaticamente. Para "Testemunha 1", oferecer botões de atalho para Luís e Natália, mantendo o campo editável.
...
8. **Formatação de Contratos:**
   ...
   - **Instagram:** Handles de Instagram devem SEMPRE ser precedidos por "@" (ex: @meu_perfil) nos documentos gerados.
